  ...
  const handlePageHighlight = React.useCallback(
    (isComponent: boolean, item: { url: string; name?: React.ReactNode }) => {
      if (isComponent) {
        ...
        setCopyPayload(
          `${packageManager} dlx levva@latest add ${componentName}`
        )
      } else {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        ...
        className="rounded-xl border-none bg-clip-padding p-2 pb-11 shadow-2xl ring-4 ring-neutral-200/80 dark:bg-primary dark:ring-neutral-800"
      >
        ...
        <div className="text-muted-foreground absolute inset-x-0 bottom-0 z-20 flex h-10 items-center gap-2 rounded-b-xl border-t border-t-neutral-100 bg-primary px-4 text-xs font-sans dark:border-t-neutral-700 dark:bg-primary">
