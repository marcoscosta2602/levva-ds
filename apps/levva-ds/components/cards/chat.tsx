        ...
        <CardHeader className="flex flex-row items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-0.5">
              <p className="text-sm leading-none font-sans">Sofia Davis</p>
              <p className="text-muted-foreground text-xs">m@levva.com</p>
            </div>
          </div>
              ...
              <CommandGroup>
                {users.map((user) => (
                  ...
                  >
                    ...
                    <div className="ml-2">
                      <p className="text-sm leading-none font-sans">
                        {user.name}
                      </p>
