        ...
        <div className="flex items-center">
          {THEMES.map((theme) => (
            <Button
              ...
              className="text-muted-foreground hover:text-primary data-[active=true]:text-primary flex h-7 cursor-pointer items-center justify-center px-4 text-center text-base font-sans capitalize transition-colors hover:no-underline"
