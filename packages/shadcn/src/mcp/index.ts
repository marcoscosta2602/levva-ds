      ...
      case "init": {
        ...
        if (rules) {
          text += `
                ...
                \`\`\`bash
                npx levva@canary add ${getRegistryItemUrl(
                  rules.name,
                  REGISTRY_URL
                )}
                \`\`\`
          ...
          content: [
            {
              ...
              \`\`\`bash
              npx levva@canary init ${getRegistryItemUrl(
                style.name,
                REGISTRY_URL
              )}
              \`\`\`
          ...
          content: [
            {
              ...
              \`\`\`
                - Example: npx levva@canary add ${getRegistryItemUrl(
