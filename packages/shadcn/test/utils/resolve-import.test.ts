...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/levva/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/levva/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/levva/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/levva/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/levva/Projects/foobar/lib/utils")
})
