...
describe("resolveFilePath", () => {
  test.each([
    ...
    },
    {
      ...
      file: {
        path: "hello-world/components/levva-card.tsx",
        type: "registry:component",
        target: "components/cards/levva-card.tsx",
      },
      resolvedPath: "/foo/bar/components/cards/levva-card.tsx",
      projectInfo: {
        isSrcDir: false,
      },
    },
  ...
  test("should resolve registry:component and registry:block file types", () => {
    ...
    ).toBe("/foo/bar/components/levva-card.tsx")
    ...
    ).toBe("/foo/bar/src/components/levva-card.tsx")
  ...
  test("should resolve nested files", () => {
    expect(
      resolveFilePath(
        {
          path: "hello-world/components/path/to/levva-card.tsx",
          type: "registry:component",
        },
        {
          resolvedPaths: {
    ...
    ).toBe("/foo/bar/components/path/to/levva-card.tsx")
  ...
  test.each([
    {
      ...
      filePath: "hello-world/components/path/to/levva-card.tsx",
      targetDir: "/foo/bar/components",
      expected: "path/to/levva-card.tsx",
    },
    {
...
describe("toAliasedImport", () => {
  ...
  test("should support @levva alias prefix", () => {
    const filePath = "components/ui/button.tsx"
    const config = {
      resolvedPaths: {
        cwd: "/foo/bar",
